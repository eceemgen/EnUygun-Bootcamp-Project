...
enterOneByOne('484303778964', ID)

WebUI.click(findTestObject('WebUITests/ReservationPage/PassengerInfoArea/1stPassenger/select1stPassengerGenderWoman')
    )

WebUI.click(findTestObject('WebUITests/ReservationPage/selectAssurance')
    )

WebUI.click(findTestObject('WebUITests/ReservationPage/InvoiceInfoArea/openInvoiceInfo')
    )

WebUI.click(findTestObject('WebUITests/ReservationPage/InvoiceInfoArea/selectInvoiceCountry')
    )

WebUI.click(findTestObject('WebUITests/ReservationPage/InvoiceInfoArea/selectInvoiceCity')
    )

WebUI.click(findTestObject('WebUITests/ReservationPage/InvoiceInfoArea/selectInvoiceTown')
    )

WebUI.setText(findTestObject('WebUITests/ReservationPage/InvoiceInfoArea/invoiceAddressInput'), 'Bebek Mahallesi'
    )
